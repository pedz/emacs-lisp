;; Lexer and parser support for wisent Ruby grammar
;;
;; Dan Debertin <airboss@nodewarrior.org>
;;
;; Depends on 'ruby-mode.el', not (as yet) included with Emacs.
;; Find it in your Ruby source directory under 'misc'.
;;
